# Generated by Django 2.0 on 2018-08-26 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(2, '二级类目'), (1, '一级类目'), (3, '三级类目')], help_text='类名级别', verbose_name='类名级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='goods.Goods', verbose_name='商品名')),
            ],
            options={
                'verbose_name': '商品图片',
