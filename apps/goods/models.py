...
class GoodsCategory(models.Model):
    ...
    category_type = models.IntegerField(choices=CATEGORY_TYPE, verbose_name='类名级别', help_text='类名级别')
...
class GoodsImage(models.Model):
    ...
    商品轮播图
    """
    goods = models.ForeignKey(Goods, verbose_name='商品名', related_name='images', on_delete=models.CASCADE)
